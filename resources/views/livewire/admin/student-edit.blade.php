              ...
              <div class="card-body">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    @error('father_name') <span class="text-danger error">{{ $message }}</span>
                    @enderror
                  </div>
                  <div class="form-group col-md-6">
                    <label>Mother Name</label>
                    <input type="text" class="form-control" wire:model='mother_name' />
                    @error('mother_name') <span class="text-danger error">{{ $message }}</span>
                    @enderror
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    @error('father_education') <span class="text-danger error">{{ $message }}</span>
                    @enderror
                  </div>
                  <div class="form-group col-md-6">
                    <label>Education Qualification of Mother</label>
                    <input type="text" class="form-control" wire:model='mother_education' />
                    @error('mother_education') <span class="text-danger error">{{ $message }}</span>
                    @enderror
                  </div>
                </div>
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    @error('father_cnic') <span class="text-danger error">{{ $message }}</span>
                    @enderror
                  </div>
                  <div class="form-group col-md-6">
                    <label>Father Phone</label>
                    <input type="text" class="form-control" wire:model='father_phone' />
                    @error('father_phone') <span class="text-danger error">{{ $message }}</span>
                    @enderror
                  </div>
                </div>
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    @error('guardian_name') <span class="text-danger error">{{ $message }}</span>
                    @enderror
                  </div>
                  <div class="form-group col-md-6">
                    <label>Guardian Occupation</label>
                    <input type="text" class="form-control" wire:model='guardian_occupation' />
                    @error('guardian_occupation') <span class="text-danger error">{{ $message
                      }}</span> @enderror
                  </div>
                </div>
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    @error('guardian_cnic') <span class="text-danger error">{{ $message }}</span>
                    @enderror
                  </div>
                  <div class="form-group col-md-6">
                    <label>Guardian Phone</label>
                    <input type="text" class="form-control" wire:model='guardian_phone' />
                    @error('guardian_phone') <span class="text-danger error">{{ $message }}</span>
                    @enderror
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  @error('guardian_address') <span class="text-danger error">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    @error('session') <span class="text-danger error">{{ $message }}</span>
                    @enderror
                  </div>
                  <div class="form-group col-md-6">
                    <label>Class In Which Admission Sought</label>
                    <input type="text" class="form-control" wire:model='admission_class' />
                    @error('admission_class') <span class="text-danger error">{{ $message }}</span>
                    @enderror
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  @error('last_school') <span class="text-danger error">{{ $message }}</span>
                  @enderror
                </div>
