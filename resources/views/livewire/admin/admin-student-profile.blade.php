                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="">
                                ...
                                <p class="clearfix">
                                    <span class="float-left">Guardian Name </span>
                                    <span class="float-right text-muted">
                                        <a href="#">{{ $student->guardian_name }}</a>
                                    </span>
                                </p>
                                <p class="clearfix">
                                    <span class="float-left">Guardian Contact</span>
                                    <span class="float-right text-muted">
                                        <a href="#">{{ $student->guardian_phone }}</a>
                                    </span>
                                </p>
                            </div>
                        </div>
                                ...
                                <div class="tab-pane fade show active" id="about" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-6 b-r">
                                            <strong>Email</strong>
                                            <br />
                                            <p class="text-muted">{{ $student->email ? $student->email : 'NILL' }}</p>
                                        </div>
