                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select wire:model="class_teacher" class="form-control">
                                            <option value="">Select Class Teacher</option>
                                            @foreach ($teachers as $teacher)
                                            <option value="{{ $teacher->id }}" @if ($teacher->id ==
                                                $class->class_teacher) selected @endif>{{ $teacher->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                        @error('class_teacher') <span class="text-danger error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                            </div>
